...
// Icons
import { faGithub, faLinkedinIn, faMediumM, faSoundcloud, faGitlab } from "@fortawesome/free-brands-svg-icons";
...
const Contact = () => (
  <ContactWrapper>
    ...
    <IconsWrapper>
      ...
      <a target="_blank" rel="noopener noreferrer" href="https://gitlab.com/jackie.lc11"><FontAwesomeIcon icon={faGitlab} /></a> 
