...
const Portfolio = () => {
  const projects = [
    ...
    {id: 2, slug: "https://github.com/JackieCalapristi/simple-tetris", subtitle: "Just For Fun", title: "Tetris", date: "July 2020", excerpt: "I built a simple tetris game using only React & React Hooks. The jury is still out regarding if this was a good idea, but I learned a lot & had a lot of fun making this!", imageUrl: Tetris},
    ...
    {id: 7, slug: "https://www.conversica.com/", subtitle: "Professional Work", title: "Conversica", date: "2015 - 2017", excerpt: "I helped build many features within Conversica's free trial & paid Machine Learning SaaS products including improvements to thier OLAP system, Rules Engine & multiple APIs. I also snagged a gamification ML patent.", imageUrl: Conversica},
