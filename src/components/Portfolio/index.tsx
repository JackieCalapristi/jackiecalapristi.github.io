...
const Portfolio = () => {
  const projects = [
    ...
    {id: 8, slug: "https://www.smartsheet.com/platform/10000ft", subtitle: "Professional Work", title: "10,000ft", date: "2017 - 2019", excerpt: "At 10Kft I built numerous features within their high level product managment software including ones that helped increase ARR 30% & ultimately get aquired.", imageUrl: TenThousandFeet, acquisition: "Aquired by Smartsheet"},
    {id: 9, slug: "https://www.conversica.com/", subtitle: "Professional Work", title: "Conversica", date: "2015 - 2017", excerpt: "I helped build many features within Conversica's free trial & paid Machine Learning SaaS products including improvements to thier OLAP system, Rules Engine & multiple APIs. I also snagged a gamification ML patent.", imageUrl: Conversica, acquisition: "Series E"},
